...
import { AlertTriangle, Download, Loader2, ChevronDown, ChevronUp, Sparkles } from "lucide-react";
...
export default function Results() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.download = `zubchek-report-${new Date().toISOString().slice(0, 10)}.png`;
      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 max-w-lg lg:max-w-4xl mx-auto w-full">
        <div ref={reportRef} className="bg-white dark:bg-gray-900 p-4 sm:p-6">
          ...
          {analysisResult.report_id && (
            <ExtendedRecommendations reportId={analysisResult.report_id} lang={lang} t={t} />
          )}
